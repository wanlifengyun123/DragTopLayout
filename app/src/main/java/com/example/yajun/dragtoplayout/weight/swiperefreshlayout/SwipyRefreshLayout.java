...
package com.example.yajun.dragtoplayout.weight.swiperefreshlayout;
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a3 = context.obtainStyledAttributes(
                attrs, R.styleable.SwipyRefreshLayout);
        mScrollableChildId = a3.getResourceId(R.styleable.SwipyRefreshLayout_scrollView, 0);
